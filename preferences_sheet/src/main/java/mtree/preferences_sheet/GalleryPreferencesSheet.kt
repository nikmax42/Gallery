...
private fun GalleryPreferencesMenu(
    ...
    var selectedTab by remember { mutableStateOf(Tab.APPEARANCE) }
    ...
    Column(
                        ...
                        FilterChip(
                            ...
                            label = {
                                val modeName = when (mode) {
                                    GalleryMode.TREE -> stringResource(R.string.tree_mode)
                                    GalleryMode.PLAIN -> stringResource(R.string.plain_mode)
                                }
                                Text(text = modeName)
                            }
                        )
                        ...
                        FilterChip(
                            ...
                            leadingIcon = {
                                if (selected) Icon(
                                    ...
                                    when (it) {
                                        DynamicColors.SYSTEM -> Icon(
                                            imageVector = Icons.Outlined.Palette,
                                            contentDescription = null,
                                            modifier = Modifier.size(18.dp)
                                        )
                                        DynamicColors.DISABLED -> Icon(
                                            painter = painterResource(R.drawable.palette_disabled),
                                            contentDescription = null,
                                            modifier = Modifier.size(18.dp)
                                        )
                                    }
        ...
        Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
            ...
            Column {
                ...
                Text(
                    text = stringResource(R.string.grid_columns_portrait, value.toInt()),
            ...
            Column {
                ...
                Text(
                    text = stringResource(R.string.grid_columns_landscape, value.toInt()),
                    style = MaterialTheme.typography.labelMedium
                )
                Slider(
                    value = value,
                ...
                SortOrder.entries.forEach { order ->
                    TextButton(
                        ...
                        Row(modifier = Modifier.fillMaxWidth()) {
                            ...
                            val text = when (order) {
                                SortOrder.MODIFICATION_DATE -> stringResource(R.string.creation_date)
                                SortOrder.CREATIOIN_DATE -> stringResource(R.string.modification_date)
            ...
            LazyRow(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                item {
                    FilterChip(
                        ...
                        label = { Text(stringResource(R.string.unhidden)) },
                        leadingIcon = {
