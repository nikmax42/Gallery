package mtree.viewer.components.contents
...
import mtree.viewer.components.FramePreview
import mtree.viewer.components.Image
import mtree.viewer.components.PlayPauseButton
import mtree.viewer.components.Seekbar
import mtree.viewer.components.Video
import mtree.viewer.components.bottom_bar.ViewerBottomBar
import mtree.viewer.components.top_bar.ViewerTopBar
...
internal fun MainContent(
    ...
    val initialPage = remember(initialFile, files) {
        files
            .indexOf(initialFile)
