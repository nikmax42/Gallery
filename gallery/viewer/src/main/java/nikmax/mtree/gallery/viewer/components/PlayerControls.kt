package nikmax.mtree.gallery.viewer.components
...
import nikmax.mtree.gallery.core.utils.MeasurementUnitsUtils.percentageToPosition
import nikmax.mtree.gallery.core.utils.MeasurementUnitsUtils.positionToPercentage
import nikmax.mtree.gallery.core.utils.MeasurementUnitsUtils.videoDurationToString
...
internal fun FramePreview(
    ...
    Timber.d("previewRequest: $imageRequest")
    AsyncImage(
        model = imageRequest,
